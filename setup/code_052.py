...
mytelescope_param = {
    'telescope_instrument': 'Newton 0.61-m/SBIG ST-10 Dual CCD Camera',  # telescope/instrument name
    'telescope_keyword': '052',  # telescope/instrument keyword
...
implemented_telescopes.append('052')

# translate INSTRUME (or others, see _pp_conf.py) header keyword into
#   PP telescope keyword
# example: INSTRUME keyword in header is 'mytel'
instrument_identifiers['instrume_identifier'] = '052'

# translate telescope keyword into parameter set defined here
telescope_parameters['052'] = code052_param
