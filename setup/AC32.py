...
mytelescope_param = {
    'telescope_instrument': 'AC32/CCD FLI PL4240',  # telescope/instrument name
    'telescope_keyword': 'AC32',  # telescope/instrument keyword
...
implemented_telescopes.append('AC32')

# translate INSTRUME (or others, see _pp_conf.py) header keyword into
#   PP telescope keyword
# example: INSTRUME keyword in header is 'mytel'
instrument_identifiers['instrume_identifier'] = 'AC32'

# translate telescope keyword into parameter set defined here
telescope_parameters['AC32'] = AC32_param
