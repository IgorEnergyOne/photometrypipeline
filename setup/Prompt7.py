...
mytelescope_param = {
    'telescope_instrument': 'Prompt7',  # telescope/instrument name
...
implemented_telescopes.append('Prompt7')

# translate INSTRUME (or others, see _pp_conf.py) header keyword into
#   PP telescope keyword
# example: INSTRUME keyword in header is 'mytel'
instrument_identifiers['instrume_identifier'] = 'Prompt7'

# translate telescope keyword into parameter set defined here
telescope_parameters['Prompt7'] = Prompt7_param
